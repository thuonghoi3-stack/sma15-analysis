...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-nHl0cEOw.mjs");
...
var manifest = { "07af06d9289fbf741436e7520fb3c5bfc316976ba9e6fec2dc900d4cb21076b1": {
	functionName: "loadStudy_createServerFn_handler",
	importer: () => import("./load-study-BpFo0GLi.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-D-PgPs9N.mjs").then((n) => n.t),
